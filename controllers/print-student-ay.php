...
// All Students List
  ...
  // t4 - Academic List
    ...
    $pdf->Cell(20,0,'',0,0);
    $pdf->Cell(120,0,'Academic List of Students For The School Year' ,0,1,'');
    $pdf->Cell(25,0,'',0,0);
  ...
  ';
    ...
    $sqlStudentM = "SELECT s_ay.s_school_yearID, s_ay.studentID, s.student_id, s.s_id_number, s.s_first_name, s.s_middle_name, s.s_last_name, s.gender, s.status FROM student_ay s_ay 
     JOIN student s 
     ON s_ay.studentID = s.student_id
     WHERE s_ay.s_school_yearID = '$schoolyear' AND s.gender = '1' AND s.status = '1'
  ...
  $sqlStudentF = " SELECT s_ay.s_school_yearID, s_ay.studentID, s.student_id, s.s_id_number, s.s_first_name,
     s.s_middle_name, s.s_last_name, s.gender, s.status FROM student_ay s_ay 
     JOIN student s 
     ON s_ay.studentID = s.student_id
     WHERE s_ay.s_school_yearID = '$schoolyear' AND s.gender = '2' AND s.status = '1'
     ORDER BY s.s_id_number ASC
    ";
