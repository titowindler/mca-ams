 ...
 -->
      ...
      <div class="main-content" style="min-height: 566px;">
        ...
        <!-- -->
          ...
          $sqlTotalClasses = "SELECT * FROM class 
          WHERE status = '1'
          AND class_adviser = '$teacherID' ";
...
<!--           <?php  
          ...
          //$sqlTotalSubjects = "SELECT DISTINCT(csubj.csubj_classID), s.subject_id,s.status, t.teacher_id, csubj.csubj_teacherID, csubj.csubj_subjectID 
 ...
 -->
            <!-- <div class="col-lg-4 col-md-4 col-sm-4 col-12">
              <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                  <div class="card-header">
                    <h4>Total Other Subject Classes</h4>
                  </div>
                  <div class="card-body">
