              ...
              <a href="dashboard.php" class="nav-link"><i class="fas fa-columns"></i><span>Dashboard</span></a>
               ...
               <li class="nav-item active dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li class="nav-item active"><a href="adviser-class.php" class="nav-link"> <span>Advisery Class</span> </a></li>
      ...
      <div class="main-content" style="min-height: 566px;">
        <section class="section">
          <div class="section-header">
            <h1>View Advisery Class</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
              <div class="breadcrumb-item"><a href="#">Advisery Class</a></div>
              <div class="breadcrumb-item">View Advisery Class</div>
            </div>
          </div>
          ...
          <div class="section-body">
            ...
            <div class="card">
              <div class="card-header">
                 <h4>View Advisery Class</h4>
                  <div class="card-header-action">
                    <a href="adviser-class.php" class="btn btn-danger btn-sm"><i class="far fa-arrow-alt-circle-left"></i> Return </a>
                  </div>
              </div>
            ...
            <div class="card">
              <div class="card-header">
                <h4>Class Subject Masterlist</h4>
                  <div class="card-header-action">
                    <a href="../../controllers/teacher-print-class-subject.php?ac=<?php echo $getClass?>" class="btn btn-primary btn-sm text-white" target="_blank"><i class="fas fa-print"></i> Print</a>
                  ...
                  <table class="table table-hover table-bordered">
                    <thead class="thead-light">
                      ...
                      <tr>
                        <?php if($rowMonday['class_subject_day'] == 'Monday') { ?>
                          ...
                          <td><?php echo $rowMonday['t_first_name'];?> <?php echo $rowMonday['t_middle_name'][0]?>. <?php echo $rowMonday['t_last_name'];?></td>
                       </tr>
                    ...
                    <tr>
                        <?php if($rowTuesday['class_subject_day'] == 'Tuesday') { ?>
                          ...
                          <td><?php echo $rowTuesday['t_first_name'];?> <?php echo $rowTuesday['t_middle_name'][0]?>. <?php echo $rowTuesday['t_last_name'];?></td>
                    ...
                    <?php
                        ...
                        <?php if($rowWednesday['class_subject_day'] == 'Wednesday') { ?>
                          ...
                          <td><?php echo $rowWednesday['t_first_name'];?> <?php echo $rowMonday['t_middle_name'][0]?>. <?php echo $rowWednesday['t_last_name'];?></td>
                          <?php } ?>
                      </tr>
                       <?php  
                           } 
                   ...
                   <?php
                     ...
                     <tr>
                        <?php if($rowThursday['class_subject_day'] == 'Thursday') { ?>
                          ...
                          <td><?php echo $rowThursday['t_first_name'];?> <?php echo $rowThursday['t_middle_name'][0]?>. <?php echo $rowThursday['t_last_name'];?></td>
                         <?php } ?>
                      </tr>
                       <?php  
                           } 
                   ...
                   <?php
                     ...
                     <tr>
                        <?php if($rowFriday['class_subject_day'] == 'Friday') { ?>
                          ...
                          <td><?php echo $rowFriday['t_first_name'];?> <?php echo $rowFriday['t_middle_name'][0]?>. <?php echo $rowFriday['t_last_name'];?></td>
                    <?php } ?>
                      </tr>
                       <?php  
                           } 
