                ...
                <div class="card-body">
                    ...
                    <thead class="thead-light">
                          ...
                          <tr>
                            ...
                            <th>100</th>
                             <th> 
                              <div contentEditable='true' class='validatePSWW' id='calculate_psww_<?php echo $get_ps?>' data-mask="00%"> <?php echo $percentage_ww ?>
                              </div> 
                            </th>
                            <!-- -->
                            ...
                            <th>100</th>
                             <th> 
                              <div contentEditable='true' class='validatePSPT' id='calculate_pspt_<?php echo $get_ps?>' data-mask="00%"> <?php echo $percentage_pt ?>%
                              </div> 
                            </th>
                            ...
                            <th>100</th>
                            <th> 
                              <div contentEditable='true' class='validatePSQA' id='calculate_psqa_<?php echo $get_ps?>' data-mask="00%"> <?php echo $percentage_qa ?>%
                              </div> 
                            </th>
                          </tr>
                        ...
                        <tbody>
                          ...
                          <input type="hidden" value="<?php echo $get_grading_quarter ?>" name="cg_calculategrade_grading_quarter">
                           ...
                           <?php 
                            ...
                            <?php if($rowMales['calculategrade_ss_qa1'] > 0) { ?>
                            <td><button class="btn btn-success btn-sm submitGradebtnMale" id='<?php echo $rowMales['calculategrade_id']?>_qsg_<?php echo $ss_quarterly_grade?>'>Submit Grade</button></td>
                          <?php } else { ?>
                              <td><button class="btn btn-disabled btn-sm">Submit Grade</button></td>
                          <?php } ?>
...
$(document).ready(function(){
    ...
    // Save data
    $(".validatePSWW").keydown(function(e){
      ...
      if(filterValue > filterMax) {
        ...
        $.ajax({
            ...
            type: 'post',
            data: { field_name:field_name, value:value, id:edit_id, validate: ps_ww },
...
$(document).ready(function(){
    ...
    // Save data
    $(".validatePSPT").keydown(function(e){
      ...
      if(filterValue > filterMax) {
        ...
        $.ajax({
            url: '../../controllers/new-calculate-grade.php',
            type: 'post',
            data: { field_name:field_name, value:value, id:edit_id, validate: ps_pt },
            success:function(response){
                if(response == 1){ 
                    console.log('Save successfully'); 
                    location.reload();
...
$(document).ready(function(){
    ...
    // Save data
    $(".validatePSQA").keydown(function(e){
      ...
      if(filterValue > filterMax) {
        ...
        $.ajax({
            url: '../../controllers/new-calculate-grade.php',
            type: 'post',
            data: { field_name:field_name, value:value, id:edit_id, validate: ps_qa },
            success:function(response){
                if(response == 1){ 
                    console.log('Save successfully'); 
                    location.reload();
...
$(document).ready(function(){
    ...
    // Save data
    $(".validateHPSWW").keydown(function(e){
...
$(document).ready(function(){
    ...
    // Save data
    $(".validateHPSPT").keydown(function(e){
...
$(document).ready(function(){
    ...
    // Save data
    $(".validateHPSQA").keydown(function(e){
