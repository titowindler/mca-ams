          ...
          <div class="section-body">
            ...
            <div class="card">
              <div class="card-header">
                <h4>Student List</h4>
                  <div class="card-header-action">
                    <a href="#" onclick="location.reload();" class="btn btn-danger btn-sm text-white"><i class="fas fa-undo"></i> Reload</a>
                         ...
                         <?php
                          ...
                          <tr>
                           ...
                           <?php 
                            ...
                            <?php if($rowFemales['calculategrade_ss_qa1'] > 0) { ?>
                            <td><button class="btn btn-success btn-sm submitGradebtnMale" id='<?php echo $rowFemales['calculategrade_id']?>_qsg_<?php echo $ss_quarterly_grade?>'>Submit Grade</button></td>
                          <?php } else { ?>
                              <td><button class="btn btn-disabled btn-sm">Submit Grade</button></td>
                          <?php } ?>
