        ...
        <ul class="navbar-nav navbar-right">
          ...
          <!-- Menu Dropdodwn for changepassword, profile, settings and logout -->
            <?php require("menu-listdropdown.php");
              ...
              $sqlGetAcadInfo = "SELECT * FROM academic_year WHERE academic_year_id = '$getAcademicYear'
              ";

              $resultGetAcadInfo = mysqli_query($conn,$sqlGetAcadInfo);

              while($rowGetAcadInfo = mysqli_fetch_assoc($resultGetAcadInfo)) {
                  $school_year = $rowGetAcadInfo['school_year'];
              }
      ...
      <div class="main-content" style="min-height: 566px;">
        <section class="section">
          <div class="section-header">
            <h1>View Grade Class - <?php echo $school_year ?></h1>
          ...
          <div class="section-body">
            ...
            <div class="card">
              <div class="card-header">
                <h4>Grade Class Subject List</h4>
                  <div class="card-header-action">
                     <a href="calculate-grade.php" class="btn btn-danger btn-sm"><i class="far fa-arrow-alt-circle-left"></i> Return </a>
                  </div>
              </div>
            <div class="card-body">
                  ...
                  <table class="table table-hover table-bordered" id="table-class-student">
                    <thead class="thead-light">
                        ...
                        <?php
                          ...
                          // back-up sql
                          // $sql = "SELECT DISTINCT(ps.percentagescore_subject_id), s.subject_name,ps.percentagescore_teacher_id, ps.percentagescore_academic_year_id,ps.percentagescore_class_id, c.class_adviser,c.class_name,c.class_section, c.class_gradelevel, FROM percentage_score ps
                          // JOIN class c
                          ...
                          // WHERE ps.percentagescore_academic_year_id = '$getAcademicYear'
                          // AND ps.percentagescore_teacher_id = '$teacher_id'
                          // ";
                        ...
                        <tr>
                          ...
                          <?php if($row['percentagescore_teacher_id'] == $row['class_adviser']) { ?>
                            <td> <div class="badge badge-primary badge-sm">Adviser</div> </td>
                          <?php } else { ?>
                            <td> <div class="badge badge-primary badge-sm">Subject Teacher</div> </td>
                          <?php } ?>


                        
                          <td>
                            <!-- <a href="view-calculate-grade-studentlist-percentage.php?s=<?php //echo $row['percentagescore_subject_id']?>&c=<?php //echo $row['percentagescore_class_id']?>&t=<?php //echo $row['percentagescore_teacher_id']?>&ay=<?php //echo $row['percentagescore_academic_year_id'] ?>" class="btn btn-info btn-sm text-white"><i class="fas fa-box-open"></i> VIEW </a> -->

                            <a href="view-calculate-grade-studentlist-percentage.php?ps=<?php echo $row['percentagescore_id']?>" class="btn btn-info btn-sm text-white"><i class="fas fa-box-open"></i> VIEW </a>  
