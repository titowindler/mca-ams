    ...
    <!-- Main Content -->
      <div class="main-content" style="min-height: 566px;">
        <section class="section">
          ...
          // code for printing teacher schedule
          $sqlPrint = "SELECT * FROM class_subject WHERE class_subject.csubj_teacherID = '$teacherID' AND class_subject.csubj_academicyearID = '$getAcademicYear'";
          $resultSqlPrint = mysqli_query($conn,$sqlPrint);


          while($rowSqlPrint = mysqli_fetch_assoc($resultSqlPrint)) {
            $printClassID = $rowSqlPrint['csubj_classID'];
            $printTeacherID = $rowSqlPrint['csubj_teacherID'];
            $printAcademicYearID = $rowSqlPrint['csubj_academicyearID'];
          }
            ...
            <div class="card">
              <div class="card-header">
                <h4>Subject Teacher Schedule</h4>
                  <div class="card-header-action">
                    <a href="../../controllers/print-class-schedule-subteacher.php?c=<?php echo $printClassID?>&t=<?php echo $printTeacherID?>&sy=<?php echo $printAcademicYearID?>" class="btn btn-primary btn-sm text-white" target="_blank"><i class="fas fa-print"></i> Print</a>
                      </div>
              </div>
            <div class="card-body">
