              ...
              <div class="card-header">
                 <h4></h4>
                  <div class="card-header-action">
                    <a href="view-grade-class-studentlist.php?gc=<?php echo $display_class?>&ay=<?php echo $display_ay ?>" class="btn btn-danger btn-sm"><i class="far fa-arrow-alt-circle-left"></i> Return </a>
                  </div>
              </div>
                ...
                <div class="card-body">
                  <div class="form-row">
                    <div class="form-group col-md-5">
                      ...
                      <h5 class="text-dark"><?php echo $s_first_name ?> <?php echo $s_middle_name[0]?>. <?php echo $s_last_name ?> </h5>
                  </div>
                </div>
            ...
            <div class="card">
              <div class="card-header">
                <h4>Grade Class Student List</h4>
                  <div class="card-header-action">
                    <a href="#../../controllers/teacher-print-class-student.php?ac=<?php echo $getClass?>" class="btn btn-primary btn-sm text-white" target="_blank"><i class="fas fa-print"></i> Print</a>
                  </div>
              </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            ?>
              ...
              <tr>
                <th scope="row">
                  <button type="submit" id="<?php echo $class_subject ?>" class="btn btn-success inputSubject"><i class="fa fa-plus"></i></button> 
                   <?php echo $subject_name ?></th>
              
              <?php 
               $sqlStudentGrade1 = "SELECT studentgrade_id, studentgrade_classid, studentgrade_studentid, studentgrade_subjectid, studentgrade_startyear, studentgrade_endyear, studentgrade_q1 
               FROM student_grade 
               ...
               $sqlStudentGrade2 = "SELECT studentgrade_id, studentgrade_classid, studentgrade_studentid, studentgrade_subjectid, studentgrade_startyear, studentgrade_endyear, studentgrade_q2 
               FROM student_grade 
               WHERE studentgrade_subjectid = '$rowGetClassSubject[subject_id]'
               AND studentgrade_studentid = '$getStudent'
               ";
               ...
               $sqlStudentGrade3 = "SELECT studentgrade_id, studentgrade_classid, studentgrade_studentid, studentgrade_subjectid, studentgrade_startyear, studentgrade_endyear, studentgrade_q3 
               FROM student_grade 
               WHERE studentgrade_subjectid = '$rowGetClassSubject[subject_id]'
               AND studentgrade_studentid = '$getStudent'
               ";
               ...
               $sqlStudentGrade4 = "SELECT studentgrade_id, studentgrade_classid, studentgrade_studentid, studentgrade_subjectid, studentgrade_startyear, studentgrade_endyear, studentgrade_q4 
               FROM student_grade 
               WHERE studentgrade_subjectid = '$rowGetClassSubject[subject_id]'
               AND studentgrade_studentid = '$getStudent'
               ";
   ...
   <table class="table table-sm table-hover table-bordered table-center" id="table-card"> 
            <thead class="thead-light">
              <tr>
                ...
                ?>
                   <tbody id="table-body-card">
                       ...
                       <tr>
                        ...
                        <td rowspan="1"><button data-toggle="modal" data-target="#inputMakaDiyos1" type="button" class="btn btn-info inputCoreValues"><i class="fa fa-plus"></i>  </button>Expresses one's spiritual beliefs while respecting the spiritual beliefs of others.</td>
               ...
               $sqlMakadiyosOne1 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               ...
               $sqlStudentMakadiyosOne2 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               ...
               $sqlStudentMakadiyosOne3 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               ...
               $sqlStudentMakadiyosOne4 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               ...
               <?php if($displayMakadiyosOne1['studentcorevalue_classid'] == $getClass && $displayMakadiyosOne1['studentcorevalue_studentid'] == $getStudent && $displayMakadiyosOne1['studentcorevalue_quarter'] == '1st Quarter' ) {?>
                ...
                <?php } ?>
                      ...
                      <tr>
                          <td><button data-toggle="modal" data-target="#inputMakaDiyos2" class="btn btn-info inputCoreValues"><i class="fa fa-plus"></i>  </button>Shows adherence to ethical principles by upholding truth.</td>
             <?php 
               // if subject value is equal to filipino 
               // loop and display grades for all filipino
               //if() { 

               $sqlMakadiyosTwo1 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '1st Quarter' 
               ...
               $sqlStudentMakadiyosTwo2 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '2nd Quarter' 
               AND studentcorevalue_corevalueid = '2'
               AND studentcorevalue_studentid = '$getStudent'
               ...
               $sqlStudentMakadiyosTwo3 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '3rd Quarter' 
               AND studentcorevalue_corevalueid = '2'
               AND studentcorevalue_studentid = '$getStudent'
               ...
               $sqlStudentMakadiyosTwo4 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '4th Quarter' 
               AND studentcorevalue_corevalueid = '2'
               AND studentcorevalue_studentid = '$getStudent'
               ...
               <?php if($displayMakadiyosTwo1['studentcorevalue_classid'] == $getClass && $displayMakadiyosTwo1['studentcorevalue_studentid'] == $getStudent && $displayMakadiyosTwo1['studentcorevalue_quarter'] == '1st Quarter' ) {?>
                ...
                <?php } ?>
                        ...
                        <tr>
                            ...
                            <td rowspan="1"><button data-toggle="modal" data-target="#inputMakaTao1" class="btn btn-info inputCoreValues"><i class="fa fa-plus"></i>  </button>Insentive to individual, social and cultural differences.</td>
              <?php 
               // if subject value is equal to filipino 
               // loop and display grades for all filipino
               //if() { 

               $sqlMakataoOne1 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '1st Quarter' 
               ...
               $sqlStudentMakataoOne2 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '2nd Quarter' 
               AND studentcorevalue_corevalueid = '3'
               AND studentcorevalue_studentid = '$getStudent'
               ...
               $sqlStudentMakataoOne3 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '3rd Quarter' 
               AND studentcorevalue_corevalueid = '3'
               AND studentcorevalue_studentid = '$getStudent'
               ...
               $sqlStudentMakataoOne4 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '4th Quarter' 
               AND studentcorevalue_corevalueid = '3'
               AND studentcorevalue_studentid = '$getStudent'
               ...
               <?php if($displayMakataoOne1['studentcorevalue_classid'] == $getClass && $displayMakataoOne1['studentcorevalue_studentid'] == $getStudent && $displayMakataoOne1['studentcorevalue_quarter'] == '1st Quarter' ) {?>
                ...
                <?php } ?>
                        ...
                        <tr>
                          <td><button data-toggle="modal" data-target="#inputMakaTao2" class="btn btn-info inputCoreValues"><i class="fa fa-plus"></i>  </button>Demonstrates contributions towards solidarity.</td>
                        <?php 
               // if subject value is equal to filipino 
               // loop and display grades for all filipino
               //if() { 

               $sqlMakataoTwo1 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '1st Quarter' 
               ...
               $sqlStudentMakataoTwo2 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '2nd Quarter' 
               AND studentcorevalue_corevalueid = '4'
               AND studentcorevalue_studentid = '$getStudent'
               ...
               $sqlStudentMakataoTwo3 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '3rd Quarter' 
               AND studentcorevalue_corevalueid = '4'
               AND studentcorevalue_studentid = '$getStudent'
               ...
               $sqlStudentMakataoTwo4 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '4th Quarter' 
               AND studentcorevalue_corevalueid = '4'
               AND studentcorevalue_studentid = '$getStudent'
               ...
               <?php if($displayMakataoTwo1['studentcorevalue_classid'] == $getClass && $displayMakataoTwo1['studentcorevalue_studentid'] == $getStudent && $displayMakataoTwo1['studentcorevalue_quarter'] == '1st Quarter' ) {?>
                ...
                <?php } ?>
                         ...
                         <tr>
                            ...
                            <td rowspan="1"><button data-toggle="modal" data-target="#inputMakaKalikasan1" class="btn btn-info inputCoreValues"><i class="fa fa-plus"></i>  </button>Cares for the environment and utilizes resources wisely, judiciously, and economically.</td>
              <?php 
               // if subject value is equal to filipino 
               // loop and display grades for all filipino
               //if() { 

               $sqlMakakalikasanOne1 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '1st Quarter' 
               ...
               $sqlStudentMakakalikasanOne2 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '2nd Quarter' 
               AND studentcorevalue_corevalueid = '5'
               AND studentcorevalue_studentid = '$getStudent'
               ...
               $sqlStudentMakakalikasanOne3 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '3rd Quarter' 
               AND studentcorevalue_corevalueid = '5'
               AND studentcorevalue_studentid = '$getStudent'
               ...
               $sqlStudentMakakalikasanOne4 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '4th Quarter' 
               AND studentcorevalue_corevalueid = '5'
               AND studentcorevalue_studentid = '$getStudent'
               ...
               <?php if($displayMakakalikasanOne1['studentcorevalue_classid'] == $getClass && $displayMakakalikasanOne1['studentcorevalue_studentid'] == $getStudent && $displayMakakalikasanOne1['studentcorevalue_quarter'] == '1st Quarter' ) {?>
                ...
                <?php } ?>
                        ...
                        <tr>
                            ...
                            <td rowspan="1"><button data-toggle="modal" data-target="#inputMakaBansa1" class="btn btn-info inputCoreValues"><i class="fa fa-plus"></i>  </button>Demonstrates pride in being a Filipino; exercises the rights and responsibilites of a Filipino citizen.</td>
              <?php 
               // if subject value is equal to filipino 
               // loop and display grades for all filipino
               //if() { 

               $sqlMakabansaOne1 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '1st Quarter' 
               ...
               $sqlStudentMakabansaOne2 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '2nd Quarter' 
               AND studentcorevalue_corevalueid = '6'
               AND studentcorevalue_studentid = '$getStudent'
               ...
               $sqlStudentMakabansaOne3 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '3rd Quarter' 
               AND studentcorevalue_corevalueid = '6'
               AND studentcorevalue_studentid = '$getStudent'
               ...
               $sqlStudentMakabansaOne4 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '4th Quarter' 
               AND studentcorevalue_corevalueid = '6'
               AND studentcorevalue_studentid = '$getStudent'
               ...
               <?php if($displayMakabansaOne1['studentcorevalue_classid'] == $getClass && $displayMakabansaOne1['studentcorevalue_studentid'] == $getStudent && $displayMakabansaOne1['studentcorevalue_quarter'] == '1st Quarter' ) {?>
                ...
                <?php } ?>
                      ...
                      <tr>
                          <td><button data-toggle="modal" data-target="#inputMakaBansa2" class="btn btn-info inputCoreValues"><i class="fa fa-plus"></i>  </button>Demonstrates appropriate behaviour in carrying out activities in the school, community, and country.</td>
             <?php 
               // if subject value is equal to filipino 
               // loop and display grades for all filipino
               //if() { 

               $sqlMakabansaTwo1 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '1st Quarter' 
               ...
               $sqlStudentMakabansaTwo2 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '2nd Quarter' 
               AND studentcorevalue_corevalueid = '7'
                AND studentcorevalue_studentid = '$getStudent'
               ...
               $sqlStudentMakabansaTwo3 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '3rd Quarter' 
               AND studentcorevalue_corevalueid = '7'
                AND studentcorevalue_studentid = '$getStudent'
               ...
               $sqlStudentMakabansaTwo4 = "SELECT studentcorevalue_id, studentcorevalue_classid, studentcorevalue_studentid, studentcorevalue_corevalueid, studentcorevalue_startyear, studentcorevalue_endyear, studentcorevalue_quarter, studentcorevalue_marking 
               FROM student_core_value  
               WHERE studentcorevalue_quarter = '4th Quarter' 
               AND studentcorevalue_corevalueid = '7'
                AND studentcorevalue_studentid = '$getStudent'
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="inputSubject">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <form role="form" action="../../controller/grade.php" method="POST" id="formInputGrade">
                <div class="card-body">
...
<!-- input core values makadiyos 1 -->
 <div class="modal fade" id="inputMakaDiyos1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLabel">Input Core Values Makadiyos</h3>
      </div>

    <div class="modal-body">
        <div class="row">
            <div class="col-lg-12">
                <form role="form" action="../../controller/grade.php" method="POST" id="formInputCoreValues">
                 ...
                 <div class="form-group" style="margin-bottom:25px;">
                    ...
                    <div class="form-group" style="margin-bottom:25px;">
                        ...
                        <div class="modal-footer">
                              <button type="submit" name="inputCoreValues" class="btn btn-blue">Input</button>
...
<!-- input core values makatao 1 -->
 <div class="modal fade" id="inputMakaTao1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
       <div class="modal-header">
        <h3 class="modal-title" id="exampleModalLabel">Input Core Values Makatao</h3>
      </div>
...
<!-- input core values makakakalikasan 1 -->
 <div class="modal fade" id="inputMakaKalikasan1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
       <div class="modal-header">
         <h3 class="modal-title" id="exampleModalLabel">Input Core Values Makakalikasan</h3>
      </div>
...
<!-- input core values makabansa 1 -->
 <div class="modal fade" id="inputMakaBansa1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
         <h3 class="modal-title" id="exampleModalLabel">Input Core Values Makabansa</h3>
      </div>
