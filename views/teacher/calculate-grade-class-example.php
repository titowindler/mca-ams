      ...
      <div class="main-content" style="min-height: 566px;">
        <section class="section">
          <div class="section-header">
            <h1>Subject Teacher Class</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
              <div class="breadcrumb-item">Subject Teacher Class</div>
            </div>
          </div>
          ...
          <div class="section-body">
            <div class="card">
              <div class="card-header">
                <h4>Subject Teacher Class Masterlist</h4>
                              ...
                              if(mysqli_num_rows($result) > 0) {
                                while($row = mysqli_fetch_assoc($result)) { ?>
                                      ...
                                      <?php }  ?>
                                        ...
                                        <td>
                                          <a href="calculate-grade-class-studentlist-example.php?stc=<?php echo $row['academic_year_id'] ?>" class="btn btn-info btn-sm"><i class="fas fa-box-open"></i> VIEW</a>
                                        </td>
                                      </tr>
                               <?php        
                              }
