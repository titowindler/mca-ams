...
<body class="layout-3">
                  ...
                  <div class="card">
                     <div class="card-header">
                        ...
                        <div class="card-header-action">
                           <a href="../../controllers/teacher-print-student-final-grade.php?sid=<?php echo $getStudent?>&ac=<?php echo $getClass?>" class="btn btn-primary btn-sm text-white" target="_blank"><i class="fas fa-print"></i> Print</a>
                              ...
                              <table class="table table-sm table-hover table-bordered table-center" id="table-card">
                                 <thead class="thead-light">
                                    <tr>
                                       ...
                                       <!-- <th scope="col" colspan="4">Quarter <a href="#edit-view-studentcorevalue.php?=" class="btn btn-primary btn-sm text-white ml-4">EDIT</a></th> -->
                                    </tr>
                                 </thead>
                                 <?php 
                                    ?>
                                 <tbody id="table-body-card">
                                    <tr>
                                       ...
                                       <td rowspan="1"><button data-toggle="modal" data-target="#inputMakaDiyos1" type="button" class="btn btn-info"><i class="fa fa-plus"></i>  
                                       </button>Expresses one's spiritual beliefs while respecting the spiritual beliefs of others.</td>
                                       <?php 
      ...
      <div class="modal-content">
         ...
         <form role="form" action="../../controllers/grade.php" method="POST" id="formInputGrade">
               ...
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="input_grade" id="input_grade" data-mask="00" >
               </div>
      ...
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="row">
                  <div class="col-lg-12">
                     <form role="form" action="../../controllers/grade.php" method="POST" id="formInputCoreValuesOne">
                        ...
                        <div class="form-group" style="margin-bottom:25px;">
                         ...
                         <div class="form-group" style="margin-bottom:25px;">
                            <center><p class="text-danger" style="font-size:12px;"><i>NOTE: CANNOT ADD THE SAME CORE VALUE</i></p></center>
                         </div>
      ...
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="row">
                  <div class="col-lg-12">
                     <form role="form" action="../../controllers/grade.php" method="POST" id="formInputCoreValuesTwo">
      ...
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="row">
                  <div class="col-lg-12">
                     <form role="form" action="../../controllers/grade.php" method="POST" id="formInputCoreValuesThree">
      ...
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="row">
                  <div class="col-lg-12">
                     <form role="form" action="../../controllers/grade.php" method="POST" id="formInputCoreValuesFour">
      ...
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="row">
                  <div class="col-lg-12">
                     <form role="form" action="../../controllers/grade.php" method="POST" id="formInputCoreValuesFive">
      ...
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="row">
                  <div class="col-lg-12">
                     <form role="form" action="../../controllers/grade.php" method="POST" id="formInputCoreValuesSix">
      ...
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            ...
            <div class="modal-body">
               <div class="row">
                  <div class="col-lg-12">
                     <form role="form" action="../../controllers/grade.php" method="POST" id="formInputCoreValuesSeven">
      ...
      return this.optional( element ) || /^[0-9-]*$/.test( value );
        ...
        $( document ).ready( function () {
          $( "#formInputGrade" ).validate({
            ...
            messages: {
              quarter: {
                required: "Please Select A Grading Quarter"
              },
              input_grade: {
                required: "Please Input Grade",
                minlength: "Please Input 2-digit for Student Grade",
                min: "Please Input Student Grade Greater than or equal to 70",
                max: "Please Input Student Grade Less than or equal to 95"
              }
            },
   ...
   <script type="text/javascript">
        ...
        $( document ).ready( function () {
          $( "#formInputCoreValuesOne" ).validate({
            submitHandler: function(form){
                form.submit();
              },
            rules: {
            ...
            messages: {
              ...
              marking: {
                required: "Please Input Core Value Marking"
              }
            },
            errorPlacement: function ( error, element ) {
              // Add the `help-block` class to the error element
 ...
 <!-- Form validation for Update Subject Form -->
   <script type="text/javascript">
        ...
        $( document ).ready( function () {
          $( "#formInputCoreValuesTwo" ).validate({
            submitHandler: function(form){
                form.submit();
              },
            rules: {
 ...
 <!-- Form validation for Update Subject Form -->
   <script type="text/javascript">
        ...
        $( document ).ready( function () {
          $( "#formInputCoreValuesThree" ).validate({
            submitHandler: function(form){
                form.submit();
              },
            rules: {
 ...
 <!-- Form validation for Update Subject Form -->
   <script type="text/javascript">
        ...
        $( document ).ready( function () {
          $( "#formInputCoreValuesFour" ).validate({
            submitHandler: function(form){
                form.submit();
              },
            rules: {
 ...
 <!-- Form validation for Update Subject Form -->
   <script type="text/javascript">
        ...
        $( document ).ready( function () {
          $( "#formInputCoreValuesFive" ).validate({
            submitHandler: function(form){
                form.submit();
              },
            rules: {
 ...
 <!-- Form validation for Update Subject Form -->
   <script type="text/javascript">
        ...
        $( document ).ready( function () {
          $( "#formInputCoreValuesSix" ).validate({
            submitHandler: function(form){
                form.submit();
              },
            rules: {
 ...
 <!-- Form validation for Update Subject Form -->
   <script type="text/javascript">
        ...
        $( document ).ready( function () {
          $( "#formInputCoreValuesSeven" ).validate({
            submitHandler: function(form){
                form.submit();
              },
            rules: {
