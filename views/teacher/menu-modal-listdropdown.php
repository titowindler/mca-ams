            ...
            <div class="modal-content">
             ...
             <form method="POST" action="../../controllers/profile.php" id="formChangePassword">
              ...
              <div class="modal-footer bg-whitesmoke br">
                <button type="submit" class="btn btn-outline-primary" name="teacherChangePasswordSubmit">SUBMIT</button>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
             ...
             <form method="POST" action="../../controllers/profile.php" id="formProfile">
                <div class="card-body">
                  ...
                  <div class="form-row">
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" class=" form-control" id="firstname" value="<?php echo $row['t_first_name'] ?>" name="firstname">
                      </div>
                      <div class="form-group col-md-6">
                        <label for="inputSubjectName">Last Name</label>
                        <input type="text" class=" form-control" id="lastname" value="<?php echo $row['t_last_name'] ?>" name="lastname">
              ...
              <div class="modal-footer bg-whitesmoke br">
                <button type="submit" class="btn btn-outline-primary" name="updateTeacherProfileSubmit">SUBMIT</button>
                <button type="button" class="btn btn-outline-danger" data-dismiss="modal" id="closeModal">CLOSE</button>
              </div>
          </form>
