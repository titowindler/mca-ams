                ...
                <div class="card-body">
                  <div class="form-row">
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputSubjectCode" placeholder="e.g A.P - 1" name="code">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputSubjectName" placeholder="e.g Aralin Panglipunan" name="name">
                         <i class="fas fa-check-circle"></i>
                         <i class="fas fa-exclamation-circle"></i>
                            <small>Error message</small>
                      </div>
