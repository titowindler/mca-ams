...
<!--       <?php //if(isset($_GET['s'])) { 
 ...
 -->
        ...
        <div class="alert alert-danger" id="fail-alert">Error</div>
                ...
                <div class="card-body">
                  ...
                  <div class="form-row">
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" class="validate form-control" id="inputSubjectCode" placeholder="e.g A.P - 1" name="code"  pattern="[a-zA-Z0-9-]+">
                          <div class="empty-fields">Please fill up this field</div>
                     
                      </div>
                      <div class="form-group col-md-6">
                        <label for="inputSubjectName">Subject Name</label>
                        <input type="text" class="validate form-control" id="inputSubjectName" placeholder="e.g Aralin Panglipunan" name="name"  pattern="[a-zA-Z]+" >
                          <div class="empty-fields">Please fill up this field</div>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputSubjectDescription">Subject Description</label>
                      <input type="text" class="validate form-control" id="inputSubjectDescription" placeholder="Write a short description about the subject" name="description"  pattern="[a-zA-Z ]+">
                         <div class="empty-fields">Please fill up this field</div>
                    </div>
                </div>
  ...
  <script src="../../assets/vendors/bootstrap-validate/dist/bootstrap-validate.js"></script>
     ...
     if(code!="" && name!="" && description!="") {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            for(var i=0; i<len; i++){
                ...
                var tr_str = "<tr>" +
                    ...
                    "<td>" + code + "</td>" +
                    "<td>" + name + "</td>" +
                    "<td><button class='btn btn-primary'>UPDATE</button> <button class='btn btn-danger'>DANGER</button></td>" +
                    "</tr>";

                $("#table-1 tbody").append(tr_str);
         ...
         $(".validate").keyup(function (e) {
           $(this).siblings('.empty-fields').fadeOut();
           $('#empty-alert').fadeOut();
        });
...
<script>
  bootstrapValidate(
    '#inputSubjectCode', 
    'regex:^[a-zA-Z0-9- ]+$:Please fill up the field using alphanumeric characters',
    );
  </script>
  ...
  bootstrapValidate(
    '#inputSubjectName', 
    'regex:^[a-zA-Z_ ]+$:Please fill up the field using aphabetic characters',
    );
  </script>
