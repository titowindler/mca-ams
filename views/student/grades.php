...
<body class="layout-3">
  <div id="app">
    <div class="main-wrapper container">
      ...
      require("menu-display-alert.php");
                                ...
                                while($row = mysqli_fetch_assoc($result)) {
                                    if($row['set_academic_year'] == '1' )   {  ?>
                                      <tr >
                                        ...
                                        <td>
                                          <a href="view-student-grades.php?stud=<?php echo $studentID ?>&gclass=<?php echo $row['class_id'] ?>" class="btn btn-info btn-sm"><i class="fas fa-box-open"></i> VIEW</a>
                                         </td>
                                      </tr>
