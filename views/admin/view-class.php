...
<body class="layout-3">
        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">View Class</div>
            </div>
          </div>
          ...
          <div class="section-body">
              ...
              <div class="card-header">
                 <h4>View Class</h4>
                  <div class="card-header-action">
                    <a href="class.php" class="btn btn-danger btn-sm"><i class="far fa-arrow-alt-circle-left"></i> Return </a>
                  </div>
              </div>
              ...
              ?>
                <div class="card-body">
                  <div class="form-row">
                    ...
                    <?php } ?>
                      <h4 class="text-dark">
                       Academic Year: <?php echo $class_academic_year ?> 
                      </h4>
            ...
            <div class="card">
              <div class="card-header">
                <h4>Class Student Masterlist</h4>
                  <div class="card-header-action">
                    <a href="../../controllers/print-class-student.php?c=<?php echo $getClass?>" class="btn btn-primary btn-sm text-white" target="_blank"><i class="fas fa-print"></i> Print</a>
                    <!-- <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#viewTeacherAy" ><i class="far fa-list-alt"></i> View</button>
                     --><button class="btn btn-success btn-sm" data-toggle="modal" data-target="#addClassStudent"><i class="far fa-plus-square"></i> Add Students</button>
                      </div>
              </div>
            <div class="card-body">
                  ...
                  <table class="table table-hover table-bordered" id="table-class-student">
                    <thead class="thead-light">
                      ...
                      <?php if($row['isLockClassStudent'] == 1) { ?>        
                          <td>
              ...
              <div class="card-footer bg-whitesmoke"> 
                ...
                $sqlIsLock = "SELECT * FROM class_student 
                WHERE cstud_classID = '$getClass'
                ORDER BY isLockClassStudent = '1' ";
                $resultIsLock = mysqli_query($conn,$sqlIsLock);
                $rowIsLock = mysqli_fetch_assoc($resultIsLock);

                if($rowIsLock['isLockClassStudent'] == 0) { ?>
                <!--     <button class="btn btn-success btn-sm saveClassStudent" id="<?php echo $getClass ?>"><i class="far fa-minus-square"></i> SAVE</button>
                --> <?php }else if($rowIsLock['isLockClassStudent'] == 1) { ?>
               <!--      <button class="btn btn-light btn-sm saveClassStudent"><i class="far fa-minus-square"></i> SAVE </button>
                --> <?php }
            ...
            <div class="card">
              <div class="card-header">
                <h4>Class Subject Masterlist</h4>
                  <div class="card-header-action">
                    <a href="../../controllers/print-class-subject.php?c=<?php echo $getClass?>" class="btn btn-primary btn-sm text-white" target="_blank"><i class="fas fa-print"></i> Print</a>
                   <!--  <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#viewTeacherAy" ><i class="far fa-list-alt"></i> View</button> --> 

               <?php  // for save student button
                $sqlIsLock = "SELECT * FROM class_student 
                WHERE cstud_classID = '$getClass'
                ORDER BY isLockClassStudent = '1' ";
                $resultIsLock = mysqli_query($conn,$sqlIsLock);
                ...
                if($rowIsLock['isLockClassStudent'] == 1) { ?>
                     <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#addClassSubject"><i class="far fa-plus-square"></i> Add Subjects</button>
                 <?php }else if($rowIsLock['isLockClassStudent'] == 0) { ?>
                     <button class="btn btn-light btn-sm"><i class="far fa-plus-square"></i> Add Subjects</button>
                <?php } ?>
            ...
            <div class="card-body">
                  ...
                  <table class="table table-hover table-bordered">
                      ...
                      <tr>
                        <?php if($rowMonday['class_subject_day'] == 'Monday') { ?>
                          ...
                          <td><?php echo $rowMonday['t_first_name'];?> <?php echo $rowMonday['t_last_name'];?></td>
                           <?php if($rowMonday['isLockClassSubject'] == 1) { ?>        
                          <td>
                    ...
                    <tr>
                        <?php if($rowTuesday['class_subject_day'] == 'Tuesday') { ?>
                          ...
                          <td><?php echo $rowTuesday['t_first_name'];?> <?php echo $rowTuesday['t_last_name'];?></td>
                           <?php if($rowTuesday['isLockClassSubject'] == 1) { ?>        
                          <td>
                    ...
                    <tr>
                        <?php if($rowWednesday['class_subject_day'] == 'Wednesday') { ?>
                          ...
                          <td><?php echo $rowWednesday['t_first_name'];?> <?php echo $rowWednesday['t_last_name'];?></td>
                           <?php if($rowWednesday['isLockClassSubject'] == 1) { ?>        
                          <td>
                   ...
                   <?php
                     ...
                     <tr>
                        <?php if($rowThursday['class_subject_day'] == 'Thursday') { ?>
                          ...
                          <td><?php echo $rowThursday['t_first_name'];?> <?php echo $rowThursday['t_last_name'];?></td>
                           <?php if($rowThursday['isLockClassSubject'] == 1) { ?>        
                          <td>
                     ...
                     <tr>
                        <?php if($rowFriday['class_subject_day'] == 'Friday') { ?>
                          ...
                          <td><?php echo $rowFriday['t_first_name'];?> <?php echo $rowFriday['t_last_name'];?></td>
                           ...
                           <?php if($rowFriday['isLockClassSubject'] == 1) { ?>        
                          <td>
              ...
              <div class="card-footer bg-whitesmoke">
                ...
                // for save subject button
                $sqlIsLockSubj = "SELECT * FROM class_subject 
                WHERE csubj_classID = '$getClass'
                ORDER BY isLockClassSubject = '1' ";
                $resultIsLockSubj = mysqli_query($conn,$sqlIsLockSubj);
                $rowIsLockSubj = mysqli_fetch_assoc($resultIsLockSubj);


                if($rowIsLockSubj['isLockClassSubject'] == 0) { ?>
                <!--     <button class="btn btn-success btn-sm saveClassSubject" id="<?php echo $getClass ?>"><i class="far fa-minus-square"></i> SAVE</button>
                --> <?php }else if($rowIsLockSubj['isLockClassSubject'] == 1) { ?>
           <!--          <button class="btn btn-light btn-sm saveClassSubject"><i class="far fa-minus-square"></i> SAVE </button>
            -->     <?php }
 ...
 -->
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
             ...
             <form method="POST" action="../../controllers/view-class.php">
                ...
                <input type="hidden" id="remove_subject_class_id" name="subjectID">
                <input type="hidden" id="remove_teacher_id" name="teacherID">
  ...
  <!-- Save Class Student Modal -->
         <!-- <div class="modal fade" tabindex="-1" role="dialog" id="exampleModal" data-backdrop="static" data-keyboard="false"> -->
        <div class="modal fade" tabindex="-1" role="dialog" id="saveClassStudent">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
             ...
             <form method="POST" action="../../controllers/view-class.php">
                ...
                <input type="hidden" id="save_class_student_classID" name="cstud_classID">
              ...
              <div class="modal-footer bg-whitesmoke br">
                <button type="submit" class="btn btn-outline-primary" name="saveClassStudentSubmit">SUBMIT</button>
                <button type="button" class="btn btn-outline-danger" data-dismiss="modal">CLOSE</button>
              </div>
...
<!-- Modals End -->
  ...
  <!-- Save Class Subject Modal -->
         <!-- <div class="modal fade" tabindex="-1" role="dialog" id="exampleModal" data-backdrop="static" data-keyboard="false"> -->
        <div class="modal fade" tabindex="-1" role="dialog" id="saveClassSubject">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title">Save Subject Data</h5>
              </div>

             <form method="POST" action="../../controllers/view-class.php">
                
                <input type="hidden" id="save_class_subject_classID" name="csubj_classID">
               
                  <div class="card-body">
                    <div class="container">
                      <div class="row">
                        <h4 class="text-muted">Do you want to save subject data ? </h4>
                      </div>
                    </div>
                  </div>
                
              <div class="modal-footer bg-whitesmoke br">
                <button type="submit" class="btn btn-outline-primary" name="saveClassSubjectSubmit">SUBMIT</button>
                <button type="button" class="btn btn-outline-danger" data-dismiss="modal">CLOSE</button>
              </div>
    ...
    $( document ).ready( function () {
      $( "#formClassSubject" ).validate({
        ...
        messages: {
          ...
          class_subject_start_time: {
            required: "Please Choose A Start Time For The Subject"
          },
          class_subject_end_time: {
            required: "Please Choose An End Time For The Subject"
          },
          class_subject_teacher: {
            required: "Please Assign A Teacher"
          }
        },
        errorPlacement: function ( error, element ) {
          // Add the `help-block` class to the error element
        ...
        $.ajax({
          url:"../../controllers/view-class.php",
            ...
            success:function(data){
                ...
                $('#remove_subject_class_id').val(data.csubj_subjectID);
                $('#remove_teacher_id').val(data.csubj_teacherID);
