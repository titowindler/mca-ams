            ...
            <div class="card-body">
                  ...
                  <table class="table table-hover table-bordered" id="table-class-student">
                    <thead class="thead-light">
                      ...
                      <?php if($row['isLockClassStudent'] == 0) { ?>        
                          <td>
            ...
            <div class="card">
              <div class="card-header">
                <h4>Class Subject Masterlist</h4>
                  <div class="card-header-action">
                    <a href="#../../controllers/print-class-subjects.php?sy=<?php echo $get_academic_year?>" class="btn btn-primary btn-sm text-white" target="_blank"><i class="fas fa-print"></i> Print</a>
                   <!--  <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#viewTeacherAy" ><i class="far fa-list-alt"></i> View</button>
                      ...
                      <tr>
                        <?php if($rowMonday['class_subject_day'] == 'Monday') { ?>
                          ...
                          <td><?php echo $rowMonday['t_first_name'];?> <?php echo $rowMonday['t_last_name'];?></td>
                           <?php if($rowMonday['isLockClassSubject'] == 0) { ?>        
                          <td>
                    ...
                    <tr>
                        <?php if($rowTuesday['class_subject_day'] == 'Tuesday') { ?>
                          ...
                          <td><?php echo $rowTuesday['t_first_name'];?> <?php echo $rowTuesday['t_last_name'];?></td>
                           <?php if($rowTuesday['isLockClassSubject'] == 0) { ?>        
                          <td>
                    ...
                    <tr>
                        <?php if($rowWednesday['class_subject_day'] == 'Wednesday') { ?>
                          ...
                          <td><?php echo $rowWednesday['t_first_name'];?> <?php echo $rowWednesday['t_last_name'];?></td>
                           <?php if($rowWednesday['isLockClassSubject'] == 0) { ?>        
                          <td>
                     ...
                     <tr>
                        <?php if($rowThursday['class_subject_day'] == 'Thursday') { ?>
                          ...
                          <td><?php echo $rowThursday['t_first_name'];?> <?php echo $rowTuesday['t_last_name'];?></td>
                           <?php if($rowThursday['isLockClassSubject'] == 0) { ?>        
                          <td>
                     ...
                     <tr>
                        <?php if($rowFriday['class_subject_day'] == 'Friday') { ?>
                          ...
                          <td><?php echo $rowFriday['t_first_name'];?> <?php echo $rowFriday['t_last_name'];?></td>
                           ...
                           <?php if($rowFriday['isLockClassSubject'] == 0) { ?>        
                          <td>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
             ...
             <form method="POST" action="../../controllers/view-class.php">
                ...
                <input type="text" id="remove_class_student_id" name="classStudentID">
                <input type="text" id="remove_class_student_class_id" name="classID">
                <input type="text" id="remove_class_student_class_studentID" name="cstud_studentID">
