          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
             ...
             <form method="POST" action="../../controllers/profile.php" id="formProfile">
                <div class="card-body">
                  ...
                  <div class="form-row">
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" class=" form-control" id="firstname" value="<?php echo $row['a_first_name'] ?>" name="firstname">
                      </div>
                      <div class="form-group col-md-6">
                        <label for="inputSubjectName">Last Name</label>
                        <input type="text" class=" form-control" id="lastname" value="<?php echo $row['a_last_name'] ?>" name="lastname">
              ...
              <div class="modal-footer bg-whitesmoke br">
                <button type="submit" class="btn btn-outline-primary" name="updateAdminProfileSubmit">SUBMIT</button>
